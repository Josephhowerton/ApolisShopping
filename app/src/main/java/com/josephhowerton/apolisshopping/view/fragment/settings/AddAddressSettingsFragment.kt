...
import com.josephhowerton.apolisshopping.databinding.FragmentAddAddressSettingsBinding
...
class AddAddressSettingsFragment : Fragment(), NetworkErrorListener {
    private val empty = "Empty!"
    private lateinit var mViewModel: AddressViewModel
    private lateinit var mBinding: FragmentAddAddressSettingsBinding
    ...
    override fun onCreateView(
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_add_address_settings, container, false)
    ...
    private fun getAddressType(): String{
        val id = mBinding.radioGroupAddressType.checkedRadioButtonId
        when(id){
    ...
    private fun setRadioButtonType(){
        when(address.type){
            "Home" -> mBinding.radioBtnOffice.isChecked = true
            "Office" -> mBinding.radioBtnOffice.isChecked = true
            "Other" -> mBinding.radioBtnOffice.isChecked = true
        }
    }
}